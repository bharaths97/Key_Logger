...
public:
	...
	KeyValPair(const string &virtualname = "", const string &name = "") : VirtualKeyName(virtualname), Name(name) {}
	string  VirtualKeyName, Name;
};

class Map_Keys
{
public:
    //List of Mapped Keys. This character map can be modified. Thus list obtained from the resource provided in course
    static map<int, KeyValPair> Keys; 
};

map<int,KeyValPair> Map_Keys::Keys
{
